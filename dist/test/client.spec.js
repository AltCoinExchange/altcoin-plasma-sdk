...
describe('client test', function () {
    it('connect', function () {
        return __awaiter(this, void 0, void 0, function () {
            var peer2, peer1, lightClient, deposit, result, state, orders2, orders;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, lightClient.deposit(altcoin_ethereum_wallet_1.TOKENS.AUGUR, 100)];
                    case 1:
                        deposit = _a.sent();
                        return [4 /*yield*/, lightClient.make(altcoin_ethereum_wallet_1.TOKENS.AUGUR, altcoin_ethereum_wallet_1.TOKENS.WETH, 10, 0.00001)];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, lightClient.getActiveOrders(true, altcoin_ethereum_wallet_1.TOKENS.WETH, altcoin_ethereum_wallet_1.TOKENS.AUGUR)];
                    case 4:
                        orders2 = _a.sent();
                        return [4 /*yield*/, lightClient.withdraw(altcoin_ethereum_wallet_1.TOKENS.AUGUR, 1)];
                    case 5:
                        orders = _a.sent();
                        // Test deposit
    ...
    it('Test events', function () {
        return __awaiter(this, void 0, void 0, function () {
            var peer2, peer1, lightClient, state;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(160000);
                        peer2 = "b37095b01e624caef9b253eeb3f1f7dc80885c9fd4d31ea20586f2dd911b51ae";
                        peer1 = "0fc067498cdbb1d8f102035cc4160469fb098c7c7fdfd0801fc6e681a982257b";
                        lightClient = new main_1.LightClient(null, lightClientConfig, "3be65d9ccb1850ee6bbb90adfa3fcb9f3cffb590c81859f550ab83b66b4b7aa2");
                        return [4 /*yield*/, lightClient.refreshState()];
                    case 1:
                        state = _a.sent();
                        console.log(JSON.stringify(state));
                        ...
                        // });
                        return [4 /*yield*/, lightClient.subscribeMulti(["$..orders", "$..accounts"], function (path, value) {
                                console.log("Event: " + path + ": " + JSON.stringify(value));
                            })];
                    case 2:
                        // await lightClient.subscribe("$..orders", (path, value) => {
